...
function main() {
    ...
    const stylizer = [{
        ...
        stylize(token, style) {
            const isControlFlowKeyword = !!/^(?:continue|default|discard|switch|return|break|while|using|case|else|goto|for|do|if)$/.exec(token);
            style.color = isControlFlowKeyword ? "#C586C0" : "#569CD6";
        },
    }, {
